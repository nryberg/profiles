...
set listchars=eol:∂,tab:õÖ,trail:_
" Enable 'wild menus'
set wildmenu
set showfulltag
...
" When in INSERT mode, set the F5 key to paste in time and date, similar to 
" Windows Notepad
imap <f5>   <C-R>=strftime("%I:%M %p %m/%d/%Y")<CR>

" Fix problem with wrapping text and inserting unwanted para's 
:set wrap
:set formatoptions=l
:set lbr 
